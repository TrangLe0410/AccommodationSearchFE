            ...
            >
                ...
                {(name === 'price' || name === 'area') && <div className='p-12 py-20 '>
                    <div className='flex flex-col items-center justify-center relative'>
                        ...
                        <div onClick={handleClickTrack} id='track' className='slider-track h-[10px] absolute top-0 bottom-0 w-full bg-gray-300 rounded-full'></div>
                        <div onClick={handleClickTrack} id='track-active' className='slider-track-active h-[10px] absolute top-0 bottom-0 bg-orange-600 rounded-full'></div>
                        <input
                            max='100'
                            min='0'
                            step='1'
