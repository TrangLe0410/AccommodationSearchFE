                ...
                {content?.length > 0 && content.map(item => {
                    return (
                        <Link
                            ...
                            className='flex gap-2 text-[#666565] items-center cursor-pointer hover:text-[#00B98E] border-b border-gray-200 pb-1 border-dashed'
                        >
                        ...
                        <div key={index} className=''>
                            <div className=' flex items-center justify-around'>
                                <div
                                    ...
                                    className='flex flex-1 gap-2 text-[#666565] items-center cursor-pointer hover:text-[#00B98E] border-b border-gray-200 pb-1 border-dashed'
                                >
                                    <GrNext size={12} color='#ccc' />
                                    <p>{item.left.value}</p>
                                </div>
                                <div
                                    ...
                                    className='flex flex-1 gap-2 items-center text-[#666565] cursor-pointer hover:text-[#00B98E] border-b border-gray-200 pb-1 border-dashed'
