...
const notActive = 'w-[46px] text-base h-[48px] flex justify-center border border-[#0E2E50] items-center bg-white hover:bg-gray-300 rounded-md'
const active = 'w-[46px] text-base h-[48px] flex justify-center items-center bg-[#0E2E50] text-white hover:opacity-90 rounded-md'
