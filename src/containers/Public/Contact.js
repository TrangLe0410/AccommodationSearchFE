...
const Contact = () => {
    return (
        <div className="w-full bg-white shadow-sm border border-gray-200 rounded-lg">
                ...
                <section class="mb-32">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <form class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                            ...
                            <button type="button"
                                class="mb-6 inline-block w-full rounded bg-[#00B98E] px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-teal-500">
                                Send
                            </button>
