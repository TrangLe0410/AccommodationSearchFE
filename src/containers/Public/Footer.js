            ...
            <footer className="bg-[#1b242e] w-full flex pt-6 p-6 lg:pt-[80px] relative z-10 fadeInUp">
                <div className="container ">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
                            <div className="w-full mb-4">
                                ...
                                <p className="text-base text-[#f3f4fe] mb-7">
                                    Luffy Land là một nền tảng giúp người dùng dễ dàng và nhanh chóng tìm kiếm chỗ ở một cách tiện lợi.
                                </p>
                      ...
                      hover:text-primary
                      leading-loose
                      mb-2 hover:text-[#3056D3] cursor-pointer
                    "
                                        >
                                            Trang Chủ
                                        </div>
