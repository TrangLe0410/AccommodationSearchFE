...
const { BsChevronRight, HiOutlineLocationMarker, TbReportMoney, GrNext, RiCrop2Line, MdOutlineHouseSiding, FiSearch } = icons
...
const Search = () => {
    ...
    return (
        <>
            <div className='p-[10px] w-5/5 my-3 bg-[#00B98E] rounded-lg flex-col lg:flex-row flex items-center justify-center  gap-2' >
                ...
                <span onClick={() => handleShowModal(provinces, 'province', 'Chọn Quận')} className='cursor-pointer flex-1'>
                    <SearchItem IconBefore={<HiOutlineLocationMarker />} IconAfter={<BsChevronRight color='rgb(156, 163, 175)' />} text={queries.province} defaultText={'Chọn Quận'} />
                </span>
                ...
                <button
                    ...
                    type='button'
                    className='w-1/5 outline-none py-2 px-4 rounded-md bg-[#0E2E50] text-base flex items-center justify-center gap-2 text-white font-medium hover:shadow-lg'
